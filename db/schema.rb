...
ActiveRecord::Schema.define(version: 2019_03_08_085530) do
  ...
  create_table "closures", id: :serial, force: :cascade do |t|
  ...
  create_table "day_records", id: :serial, force: :cascade do |t|
